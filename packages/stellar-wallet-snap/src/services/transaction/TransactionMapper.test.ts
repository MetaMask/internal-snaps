...
describe('TransactionMapper', () => {
  ...
  it.each([
    ...
    {
      testCase: 'receive native payment transaction via contract swap',
      response: contractSwapReceiveNativeTransactionResponse,
      fromAsset: getSlip44AssetId(scope),
      fromAssetSymbol: NATIVE_ASSET_SYMBOL,
      fromAmount: '59.1762381',
      toAsset: getSlip44AssetId(scope),
      toAssetSymbol: NATIVE_ASSET_SYMBOL,
      toAmount: '59.1762381',
      toAddress: accountAddress,
    ...
    {
      testCase: 'receive USDC payment transaction via contract swap',
      response: contractSwapReceiveUSDCTransactionResponse,
      fromAsset: toCaip19ClassicAssetId(
        scope,
        'USDC',
        'GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN',
