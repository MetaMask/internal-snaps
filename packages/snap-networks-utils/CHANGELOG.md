...
- Add `createSnapHandlers` for wrapped network Snap entrypoints, empty asset handlers, and an optional per-handler `logError` override. ([#341](https://github.com/MetaMask/internal-snaps/pull/341))
