...
- Add shared configuration utilities for network snaps
  - `BaseConfigProvider`, a base class owning the configuration lifecycle (parse once, build once, frozen config)
