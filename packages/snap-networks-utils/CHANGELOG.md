...
- Add shared `AssetsService` for Core AssetsController reads, plus `mapControllerAsset` and `toUiAmount` helpers ([#80](https://github.com/MetaMask/internal-snaps/pull/80))
