...
- Route Solana asset reads, fetch, and save through `CoreAssetsAdapter` when the assets migration feature flag is active. ([#123](https://github.com/MetaMask/internal-snaps/pull/123))
