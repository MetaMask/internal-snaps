...
- Fixed handling of inactive Tron accounts when fetching assets and balances, avoiding misleading HTTP errors ([#151](https://github.com/MetaMask/internal-snaps/pull/151))
